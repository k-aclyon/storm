...
class ConfigParser(object):
    ...
    def search_host(self, search_string):
        ...
        for host_entry in self.config_data:
            ...
            if search_string.upper() in searchable_information or search_string.lower() in searchable_information or search_string.capitalize() in searchable_information:
